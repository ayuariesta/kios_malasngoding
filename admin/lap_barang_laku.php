...
$query=mysqli_query($db, "select * from barang_laku where tanggal=" . $tanggal);
...
$q=mysqli_query($db, "select sum(total_harga) as total from barang_laku where tanggal=".$tanggal);
...
$qu=mysqli_query($db, "select sum(laba) as total_laba from barang_laku where tanggal=".$tanggal);
// select sum(total_harga) as total from barang_laku where tanggal='$tanggal'
