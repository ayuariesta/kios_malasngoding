...
$query=mysqli_query($db, "select * from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
...
$q=mysqli_query($db, "select sum(total_harga) as total from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
...
$qu=mysqli_query($db, "select sum(laba) as total_laba from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
